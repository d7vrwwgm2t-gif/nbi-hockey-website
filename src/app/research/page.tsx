...
import ResearchLibraryFilters from "./ResearchLibraryFilters";
  ...
  return (
    <main className="min-h-screen text-white">
      <div className="mx-auto max-w-6xl px-6 py-24">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              {nbiResearch.map((item) => (
                ...
                >
                  ...
                  <p className="mb-6 text-sm text-[#4DB5FF]">{item.author}</p>
        ...
        <ResearchLibraryFilters items={externalResearch} />
      </div>
    </main>
  );
}
